...
async def porn(ctx=SlashContext, *, user: discord.Member):
    ...
    embed.add_field(name="Important", value=text, inline=False)
    await ctx.send(embed=embed)
